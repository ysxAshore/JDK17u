...
void G1ParScanThreadState::do_partial_array(PartialArrayScanTask task)
{
  ...
  PartialArrayTaskStepper::Step step = _partial_array_stepper.next(objArrayOop(from_obj),
                                                                   to_array,
                                                  ...
                                                  oop to_obj)
{
  ...
  PartialArrayTaskStepper::Step step = _partial_array_stepper.start(objArrayOop(from_obj),
                                                                    to_array,
                                                                    _partial_objarray_chunk_size);
...
ATTRIBUTE_FLATTEN NOINLINE void G1ParScanThreadState::trim_queue_to_threshold(uint threshold)
{
  ScannerTask task;
  do
  {
...
G1ParScanThreadStateSet::G1ParScanThreadStateSet(G1CollectedHeap *g1h,
                                                 ...
                                                 uint n_workers,
                                                 size_t young_cset_length,
                                                 size_t optional_cset_length) : _g1h(g1h),
                                                                                _rdcqs(rdcqs),
