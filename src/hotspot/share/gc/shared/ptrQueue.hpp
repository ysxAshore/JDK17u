...
#define DECLARE_PADDED_MEMBER(Id, Type, Name) \
  Type Name;                                  \
  DEFINE_PAD_MINUS_SIZE(Id, DEFAULT_CACHE_LINE_SIZE, sizeof(Type))
...
public:
  ...
  uintptr_t getFreeList() { return (uintptr_t)&_free_list; }
  uintptr_t getFreeCount() { return (uintptr_t)&_free_count; }
